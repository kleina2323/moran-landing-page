...
function displayPlaceholderVideos() {
    ...
    const placeholderVideos = [
        {
            title: 'בתי אבות',
            description: 'פעילות לבעלי מוגבלות בעמידה/תנועה',
            thumbnail: 'https://drive.google.com/thumbnail?id=1FNXby3Jh0Pdtw83D4IFOH-fp_ydgyx8_&sz=w400',
            videoUrl: 'https://drive.google.com/file/d/1FNXby3Jh0Pdtw83D4IFOH-fp_ydgyx8_/preview',
            isGoogleDrive: true
        },
        {
